...
namespace Recruiting.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new RecruitingUser { UserName = Input.Email, Email = Input.Email, FullName = Input.FullName, Birthdate = Input.Birthdate };
